...
function initFluid() {
  ...
  // Canvas'ı sayfanın tamamını kaplayacak şekilde ayarla
  ...
  // Mouse event listeners - changed to document to capture everywhere
  ...
  // First mousemove with jQuery for initial setup
  if (typeof $ !== 'undefined') {
